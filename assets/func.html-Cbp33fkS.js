import{_ as n,c as s,o as a,a as e}from"./app-DtBkePuV.js";const c={},l=e(`<h1 id="faasjs-func" tabindex="-1"><a class="header-anchor" href="#faasjs-func"><span>@faasjs/func</span></a></h1><p>FaasJS 的主体模块，用于初始化云函数。</p><h2 id="使用方法" tabindex="-1"><a class="header-anchor" href="#使用方法"><span>使用方法</span></a></h2><div class="language-typescript line-numbers-mode" data-ext="ts" data-title="ts"><pre class="language-typescript"><code><span class="line"><span class="token comment">// 引入 useFunc 方法</span></span>
